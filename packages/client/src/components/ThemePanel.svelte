<script lang="ts">
  ...
  // Snapshot the current CSS variable values so inputs don't shift when the
  // user live-edits tokens like --color-bg or --color-text.
...
>
  <div class="panel" role="dialog" aria-modal="true" aria-label="Theme customization">
    <div class="panel-header">
      <span class="panel-title">Theme</span>
      <button class="close-btn" onclick={onclose} aria-label="Close theme panel">✕</button>
    </div>
